...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Bakllavë e Shtëpisë — Podujevë" },
      {
        name: "description",
        content:
          "Bakllavë e bërë në shtëpi me arra dhe pa arra. Dërgesa falas në Podujevë dhe Prishtinë.",
      },
      { property: "og:site_name", content: "Bakllavë e Shtëpisë" },
